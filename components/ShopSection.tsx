  ...
  return (
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <Link href="/custom-swag" className="group relative bg-gradient-to-br from-amber-700 to-amber-600 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:shadow-amber-600/20 transition-all flex flex-col items-center justify-center text-center p-8 min-h-[360px]">
          ...
          <div className="relative">
            ...
            <p className="text-amber-100 text-sm mb-6 leading-relaxed">Design your own magnets, keychains & NFC badges with your image</p>
            ...
            <p className="text-amber-200 text-xs mt-3 font-medium">From $5.00</p>
          </div>
        </Link>
      </div>
