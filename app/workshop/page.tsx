    ...
    <div className="bg-stone-50">
      ...
      <section className="relative overflow-hidden border-b border-stone-200">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-14 relative">
          <div className="inline-flex items-center gap-2 bg-purple-600/10 text-purple-700 text-sm font-semibold px-4 py-2 rounded-full mb-6 ring-1 ring-purple-600/20">
            <Sparkles className="w-4 h-4" />
            One-day workshop · {WORKSHOP.capacity} seats only
          </div>

          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-stone-900 mb-5 leading-[1.08] tracking-tight max-w-3xl">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-8 max-w-3xl">
            {[
              ...
              <div key={fact.label} className="bg-white rounded-xl p-4 border border-stone-200">
                <fact.icon className="w-4 h-4 text-purple-600 mb-2" />
                <p className="font-bold text-stone-900 text-sm leading-tight">{fact.label}</p>
                <p className="text-xs text-stone-500 mt-0.5">{fact.sub}</p>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              href="#register"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-purple-500 text-white px-8 py-4 rounded-xl font-bold hover:shadow-lg hover:shadow-purple-500/25 transition-all"
            >
            ...
            <a
              href="#agenda"
              className="inline-flex items-center justify-center ring-2 ring-stone-200 hover:ring-stone-300 text-stone-700 px-8 py-4 rounded-xl font-bold transition-all bg-white"
            >
              See what we cover
            </a>
          </div>
      ...
      <section className="bg-amber-50 border-b border-amber-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex items-start sm:items-center gap-4">
            <div className="w-10 h-10 bg-amber-100 rounded-xl flex items-center justify-center ring-1 ring-amber-600/20 shrink-0">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-3">
          {JOURNEY.map((step, i) => (
            <div key={step.label} className="relative bg-white rounded-2xl p-5 border border-stone-200">
              <div className="w-10 h-10 bg-purple-600/10 rounded-xl flex items-center justify-center mb-3 ring-1 ring-purple-600/15">
                <step.icon className="w-5 h-5 text-purple-600" />
              </div>
              <p className="text-[11px] font-bold text-purple-600 mb-1">STEP {i + 1}</p>
              <p className="font-bold text-stone-900 text-sm leading-tight mb-1">{step.label}</p>
      ...
      <section className="bg-white border-y border-stone-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-purple-600/10 text-purple-700 text-xs font-bold px-3 py-1.5 rounded-full mb-5 ring-1 ring-purple-600/20">
                <Wand2 className="w-3.5 h-3.5" />
                The part that used to be hard
              </div>
              <h2 className="text-3xl font-extrabold text-stone-900 mb-4 tracking-tight leading-tight">
              ...
              <div className="space-y-4 text-stone-600 leading-relaxed">
                ...
                <p>
                  <strong className="text-stone-900">That barrier is gone.</strong> We&apos;ll teach you
            ...
            <div className="bg-stone-50 rounded-2xl border border-stone-200 p-6">
              <p className="text-xs font-bold text-stone-400 uppercase tracking-wider mb-4">What this looks like</p>
              <div className="space-y-3">
                <div className="bg-white rounded-xl p-4 border border-stone-200">
                  <p className="text-[11px] font-bold text-stone-400 mb-1.5">YOU SAY</p>
                  <p className="text-sm text-stone-700 italic">
                    &ldquo;A holder for my headphones that clamps onto the edge of my desk.&rdquo;
                  </p>
                </div>
                <div className="flex justify-center">
                  <div className="w-8 h-8 bg-purple-600/10 rounded-lg flex items-center justify-center ring-1 ring-purple-600/15">
                    <Wand2 className="w-4 h-4 text-purple-600" />
                  </div>
                </div>
                <div className="bg-white rounded-xl p-4 border border-stone-200">
                  <p className="text-[11px] font-bold text-purple-600 mb-1.5">YOU GET</p>
                  <p className="text-sm text-stone-700">
                    A 3D model on your screen. You tweak it, we make sure it prints, and it
                    comes off the printer before you leave.
                  </p>
                </div>
                <div className="flex items-center gap-2 pt-2 text-stone-500">
      ...
      <section id="agenda" className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 scroll-mt-20">
        ...
        <div className="space-y-3">
          {AGENDA.map((item, i) => (
            <div
              key={item.title}
              className="bg-white rounded-2xl border border-stone-200 p-5 sm:p-6 flex flex-col sm:flex-row gap-4 sm:gap-6"
            >
              <div className="sm:w-32 shrink-0">
                <div className="flex items-center gap-2 sm:block">
                  <span className="inline-flex items-center justify-center w-6 h-6 rounded-lg bg-purple-600/10 text-purple-700 text-xs font-bold ring-1 ring-purple-600/15 sm:mb-2">
                    {i + 1}
                  </span>
                  <p className="font-mono text-sm font-semibold text-stone-500">{item.time}</p>
                </div>
              </div>
              <div>
      ...
      <section className="bg-white border-y border-stone-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-2 gap-10">
            <div>
              <div className="w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center mb-5 ring-1 ring-amber-600/20">
            ...
            <div>
              <h3 className="font-bold text-stone-900 mb-5 text-lg">What you take away</h3>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {REQUIREMENTS.map((req, i) => (
            <div
              key={req}
              className={`rounded-2xl p-5 border ${i === 0 ? 'bg-amber-50 border-amber-200' : 'bg-white border-stone-200'}`}
            >
              <div className="flex items-start gap-3">
                ...
                <p className={`text-sm leading-relaxed ${i === 0 ? 'text-amber-900' : 'text-stone-600'}`}>{req}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* ── Registration ── */}
      <section id="register" className="bg-white border-y border-stone-200 scroll-mt-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="md:sticky md:top-24">
              ...
              <div className="space-y-3 mb-6">
                {[
                  ...
                  <div key={row.label} className="flex items-start gap-3 bg-stone-50 rounded-xl p-4 border border-stone-200">
                    <row.icon className="w-4 h-4 text-purple-600 shrink-0 mt-0.5" />
                    <div>
                      <p className="text-[11px] font-bold text-stone-400 uppercase tracking-wider mb-0.5">{row.label}</p>
                      {row.href ? (
                        <a href={row.href} target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-stone-900 hover:text-purple-600 transition-colors">
                          {row.value} <span className="text-purple-600">↗</span>
                        </a>
                      ) : (
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-extrabold text-stone-900 mb-10 tracking-tight text-center">
          Questions
        </h2>
        <div className="space-y-3">
          {FAQ.map(item => (
            <details key={item.q} className="group bg-white rounded-2xl border border-stone-200 overflow-hidden">
              <summary className="flex items-center justify-between gap-4 p-5 cursor-pointer list-none font-semibold text-stone-900 hover:bg-stone-50 transition-colors">
                {item.q}
                <span className="text-stone-400 text-xl font-normal shrink-0 transition-transform group-open:rotate-45">+</span>
              </summary>
      ...
      <section className="bg-stone-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-stone-400 leading-relaxed mb-8 max-w-xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="#register"
              className="inline-flex items-center justify-center gap-2 bg-white text-stone-900 px-8 py-4 rounded-xl font-bold hover:bg-stone-100 transition-all"
            >
              Reserve your seat
              <ArrowRight className="w-4 h-4" />
            </a>
            <Link
              href="/#shop"
              className="inline-flex items-center justify-center ring-1 ring-stone-700 hover:ring-stone-600 text-stone-300 px-8 py-4 rounded-xl font-bold transition-all"
            >
              Browse the shop
            </Link>
          </div>
